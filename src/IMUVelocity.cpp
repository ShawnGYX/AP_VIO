...
CSVLine& operator<<(CSVLine& line, const IMUVelocity& imu) { return line << imu.stamp << imu.omega << imu.accel; }
CSVLine& operator>>(CSVLine& line, IMUVelocity& imu) { return line >> imu.stamp >> imu.omega >> imu.accel; }